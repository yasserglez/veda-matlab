function model = learning_cveda(params, population, fitness)
  % Learning function of the C-Vine EDA.
  %
  ...
  %   * vine_trees: number of trees of the canonical vine (for the rest
...
function [theta, h_functions, h_inverses] = estimate_parameters(params, uniform_pop)
  % Estimate the parameters of the copulas in a canonical vine.
